...
//         <>
//             <Banner />
//             <h1 style={{ color: '#407cc4', paddingTop: '20px', textAlign: 'center' }}>Product Catalog</h1>
...
import 'firebase/firestore';
import { db } from '../../firebase-config/config';
import PlantCard from '../Products/plantcard'; 
    ...
    return (
        <>
            ...
            <div className="groceries-list">
                <div className="category-container">
                    {plants.map((plant, index) => (
                        <PlantCard key={index} plant={plant} onOpenModal={onOpenModal} />
                    ))}
                </div>
            </div>
            <Modal
